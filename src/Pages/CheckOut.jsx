...
<div className="min-w-screen min-h-screen bg-primary-bg flex items-center p-5 lg:p-10 overflow-hidden relative">
    <div className="w-full max-w-6xl rounded bg-white shadow-xl p-10 lg:p-20 mx-auto text-gray-800 relative md:text-left">
        ...
        border-teal-600 transition" onClick={handleClick1}>
                <div className="flex leading-5">
                    +</div>
            </button>
            <button className="text-base  rounded-l-none border-l-0  hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer 
        hover:bg-red-200  
        bg-red-100 
        text-red-700 
        border duration-200 ease-in-out 
        border-red-600 transition" onClick={handleClick2}>
                <div className="flex leading-5"> -
                ...
                <div>
                    ...
                    <div className="inline-block align-bottom">
                        <button className="bg-green-400 opacity-75 hover:opacity-100 text-green-900 hover:text-gray-900 rounded-full px-10 py-2 font-semibold"><i className="mdi mdi-cart -ml-2 mr-2"></i> BUY NOW</button>
                    </div>
                </div>
            </div>
        </div>
