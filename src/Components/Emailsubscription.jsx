...
const Emailsubscription = () => {
    return (
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center bg-primary-bg">
        <div data-aos="fade-right" data-aos-duration="1000">
        <form action="" className="lg:py-48 py-20 flex flex-row flex-1">
        ...
        <input type="button" value="Subscribe" className="bg-green-700 hover:bg-green-400 border-0 rounded-r-2xl px-4 text-white" />
            ...
            <img  src={vegetable} alt="" className='lg:ml-24 w-96' /> 
                </div>        
    </div>
